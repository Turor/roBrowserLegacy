...
SkillEffect[SK.MH_SUMMON_LEGION] = { effectId: 311 }; //Summon Legion
SkillEffect[SK.MH_NEEDLE_OF_PARALYZE] = { hitEffectId: 1 }; //Needle of Paralyze
...
SkillEffect[SK.MH_XENO_SLASHER] = { effectId: 1082 }; //Xeno Slasher
...
SkillEffect[SK.MH_SILVERVEIN_RUSH] = { hitEffectId: 1 }; //Silver Bain Rush
SkillEffect[SK.MH_MIDNIGHT_FRENZY] = { effectId: 967 }; //Midnight Frenzy
SkillEffect[SK.MH_STAHL_HORN] = { hitEffectId: 1 }; //Steel Horn
SkillEffect[SK.MH_GOLDENE_FERSE] = { effectId: 37 }; //Golden Heel
SkillEffect[SK.MH_STEINWAND] = { groundEffectId: 56 }; //Stone Wall
SkillEffect[SK.MH_HEILIGE_STANGE] = { effectId: 152 }; //Holy Pole
SkillEffect[SK.MH_ANGRIFFS_MODUS] = { effectId: 67 }; //Attack Mode
SkillEffect[SK.MH_TINDER_BREAKER] = { effectId: 966 }; //Tinder Breaker
SkillEffect[SK.MH_CBC] = { hitEffectId: 1 }; //Continual Break Combo
SkillEffect[SK.MH_EQC] = { hitEffectId: 1 }; //Eternal Quick Combo
...
SkillEffect[SK.MH_PYROCLASTIC] = { effectId: 17 }; //Pyroclastic
