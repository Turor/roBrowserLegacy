...
class DB {
	...
	static async lazyInit() {
		...
		if (Configs.get('loadLua')) {
			...
			loadLuaValue(DB.LUA_PATH + 'skillinfoz/skillid.turoran4.lub', 'SKID', json => {
				...
				loadLuaTable(
					[DB.LUA_PATH + 'skillinfoz/skillid.turoran4.lub', DB.LUA_PATH + 'skillinfoz/skilldescript.turoran13.lub'],
					'SKILL_DESCRIPT',
					_json => {
					...
					() => {
						...
						loadSkillInfoList(DB.LUA_PATH + 'skillinfoz/skillinfolist.turoran9.lub', null, () => {
							loadSkillSpAmountTable(() => {
								loadSkillTreeView(DB.LUA_PATH + 'skillinfoz/skilltreeview.titanspear.lub', null, () => {
