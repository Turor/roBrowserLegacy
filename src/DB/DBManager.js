...
class DB {
	...
	static async lazyInit() {
		...
		if (Configs.get('loadLua')) {
			...
			loadLuaValue(DB.LUA_PATH + 'skillinfoz/skillid.turoran3.lub', 'SKID', json => {
				...
				loadLuaTable(
					[DB.LUA_PATH + 'skillinfoz/skillid.turoran3.lub', DB.LUA_PATH + 'skillinfoz/skilldescript.turoran12.lub'],
					'SKILL_DESCRIPT',
					_json => {
					...
					() => {
						...
						loadSkillInfoList(DB.LUA_PATH + 'skillinfoz/skillinfolist.turoran8.lub', null, () => {
							loadSkillSpAmountTable(() => {
								loadSkillTreeView(DB.LUA_PATH + 'skillinfoz/skilltreeview.titanaxe.lub', null, () => {
